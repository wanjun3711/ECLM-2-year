...
# 创建并训练XGBoost模型
xgb_params = {
    'alpha': 5.062660594952027,
    'eta': 0.6341040313763313,
    'gamma': 0.7093221613377343,
    'max_delta_step': 8,
    'max_depth': 2,
    'min_child_weight': 0,
    'n_estimators': 61,
    'subsample': 0.47249335500651357,
}
...
# 创建Web应用程序
st.title("2-year survival of ECLM patients based on XGBoost")
